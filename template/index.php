		...
		<section data-interactive="reserva" class="reserva">
			...
			<fieldset data-interactive="recorrido">
				...
				<div class="columna columna--doble">
					...
					<input type="text" class="datepicker" data-interactive="fecha"/>
				</div>
			...
			<fieldset class="hide" data-interactive="fieldVuelos">
				...
				<div class="columna columna--doble">
					...
					<span><input type="radio" id="categoria" name="categoria" value="Primera" data-interactive="primera"/>Primera <input type="radio" id="categoria" name="categoria" value="Economy" data-interactive="economy"/>Economy </span>
				</div>
			...
			<fieldset class="hide" data-interactive="fieldDatosPersonales">
				<h3>Para poder realizar la reserva necesitamos los siguientes datos:</h3>		
					...
					<div class="columna columna--doble">
						...
						<input name="fecha" class="datepicker" data-interactive="fecha" type="fecha" >
					</div>
					<div class="columna columna--doble">
